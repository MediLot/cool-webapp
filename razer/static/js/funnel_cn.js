...
var eventFilterHtml = '<div class="form-group row"> <label class="control-label col-md-1 col-sm-1 col-xs-12">用户的</label> <div class="select-multi-stage col-md-10 col-sm-10 col-xs-12"> <div class="col-md-5 col-sm-5 col-xs-11 width"> <select class="form-control select2-single data-table-yaml"> </select> </div> <label class="control-label float-left">是</label> <div class="col-md-6 col-sm-6 col-xs-12"> <select class="form-control second-stage"> </select> </div> <div class="col-sm-6 col-sm-6 col-xs-12 datetimepicker" style="display: none;"><div class="input-group date date1"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div><div class="input-group date date2"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div></div><div class="col-sm-6 col-sm-6 col-xs-12 intRange" style="display: none;"><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-min " placeholder="1"></div><div style="float:left; line-height:33px;">-</div><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-max " placeholder="100"></div></div></div> <i class="fa fa-plus-circle eventFilter-add" style="padding-right:7px;" aria-hidden="true"></i> <i class="fa fa-minus-circle eventFilter-remove" style="display:none;padding-right:7px;" aria-hidden="true"></i> </div>';
var cohortEventHtml = '<div class="event-container"><div class="form-group"><label class="col-sm-offset-2 control-label birthEvent-label">事件 </label><i class="fa fa-minus-circle event-remove" style="display:none;padding-left:7px" aria-hidden="true"></i></div><div class="form-group"><div class="row"><label class="control-label col-md-3 col-sm-3 col-xs-12">时间过滤：</label><div class="col-md-9 multi-eventFilters eventSelection"><div class="form-group row"><label class="control-label col-md-1 col-sm-1 col-xs-12">用户的</label><div class="select-multi-stage col-md-10 col-sm-10 col-xs-12"><div class="col-md-5 col-sm-5 col-xs-11 width"><select class="form-control select2-single data-table-yaml"></select></div><label class="control-label float-left">是</label><div class="col-md-6 col-sm-6 col-xs-12 width"><select class="form-control second-stage"> </select></div><div class="col-sm-6 col-sm-6 col-xs-12 datetimepicker" style="display:none"><div class="input-group date date1"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div><div class="input-group date date2"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div></div><div class="col-sm-6 col-sm-6 col-xs-12 intRange" style="display:none"><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-min" placeholder="1"></div><div style="float:left;line-height:33px">-</div><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-max" placeholder="100"></div></div></div><i class="fa fa-plus-circle eventFilter-add" style="padding-right:7px" aria-hidden="true"></i><i class="fa fa-minus-circle eventFilter-remove" style="display:none;padding-right:7px" aria-hidden="true"></i></div></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="min">频率：</label><div class="col-md-1 col-sm-1 col-xs-5"><input type="text" name="min" required="required" class="form-control col-md-2 col-xs-2 min" placeholder="1"></div><div style="float:left;line-height:33px">-</div><div class="col-md-1 col-sm-1 col-xs-5"><input type="text" name="max" required="required" class="form-control col-md-2 col-xs-2 max" placeholder="∞"></div><div style="float:left;line-height:33px">次</div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12">分类依据：</label><div class="col-md-3 col-sm-3 col-xs-12"><select class="form-control select2-single data-table-yaml groupby"></select></div><div class="col-md-3 col-sm-3 col-xs-12"><label class="control-label float-left">高级</label><div class="float-left"><input style="margin-top:12px;margin-left:8px" class="advanced-checkbox adv" type="checkbox" name=""></div></div></div><div class="form-group advanced-container"><div class="row"><label class="control-label col-md-offset-1 col-md-3 col-sm-3 col-xs-12">最小等级</label><div class="col-md-1 col-sm-1 col-xs-12"><input type="text" placeholder="0" class="form-control adv1" placeholder=""></div><label class="control-label col-md-1 col-sm-1 col-xs-12">等级数</label><div class="col-md-1 col-sm-1 col-xs-12"><input type="text" placeholder="10" class="form-control adv2" placeholder=""></div></div><div class="row" style="margin-top:6px"><label class="control-label col-md-offset-1 col-md-3 col-sm-3 col-xs-12">等基间距</label><div class="col-md-1 col-sm-1 col-xs-12"><input type="text" placeholder="20" class="form-control adv3" placeholder=""></div><label class="control-label col-md-1 col-sm-1 col-xs-12">指数</label><div class="col-md-1 col-sm-1 col-xs-12"><input style="margin-top:12px" class="adv4" type="checkbox" name=""></div></div></div></div></div>';
var cohortUserHtml = '<div class="event-container"><div class="form-group"><label class="col-sm-offset-2 control-label birthEvent-label">事件 </label><i class="fa fa-minus-circle event-remove" style="display:none;padding-left:7px" aria-hidden="true"></i></div><div class="form-group"><div class="row"><label class="control-label col-md-3 col-sm-3 col-xs-12">事件过滤：</label><div class="col-md-9 multi-eventFilters userSelection"><div class="form-group row"><label class="control-label col-md-1 col-sm-1 col-xs-12">用户的</label><div class="select-multi-stage col-md-10 col-sm-10 col-xs-12"><div class="col-md-5 col-sm-5 col-xs-11 width"><select class="form-control select2-single data-table-yaml"></select></div><label class="control-label float-left">是</label><div class="col-md-6 col-sm-6 col-xs-12 width"><select class="form-control second-stage"> </select></div><div class="col-sm-6 col-sm-6 col-xs-12 datetimepicker" style="display:none"><div class="input-group date date1"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div><div class="input-group date date2"><input type="text" class="form-control" /><span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span></div></div><div class="col-sm-6 col-sm-6 col-xs-12 intRange" style="display:none"><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-min" placeholder="1"></div><div style="float:left;line-height:33px">-</div><div class="col-md-5 col-sm-5 col-xs-5"><input type="text" class="form-control event-max" placeholder="100"></div></div></div><i class="fa fa-plus-circle eventFilter-add" style="padding-right:7px" aria-hidden="true"></i><i class="fa fa-minus-circle eventFilter-remove" style="display:none;padding-right:7px" aria-hidden="true"></i></div></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">频率：</label><div class="col-md-1 col-sm-1 col-xs-5"><input type="text" required="required" class="form-control col-md-2 col-xs-2 min" placeholder="1"></div><div style="float:left;line-height:33px">-</div><div class="col-md-1 col-sm-1 col-xs-5"><input type="text" required="required" class="form-control col-md-2 col-xs-2 max" placeholder="∞"></div><div style="float:left;line-height:33px">次</div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">在 </label><div style="width:80px;float:left;line-height:33px"><select class="form-control select2-single range-select first"><option>前</option><option>任意</option></select></div><div class="col-md-1 col-sm-1 col-xs-5"><input type="text" required="required" class="form-control col-md-2 col-xs-2 day" placeholder="7"></div><div style="float:left;line-height:33px;font-weight:800">天</div></div></div></div>';
...
function buildLoyal(){
	...
	for(var h = 0; h < eventSelectSize; h++){
		...
		eventSelect['timeWindow']['slice'] = (eventDiv.find('.first').val()==='任意');
