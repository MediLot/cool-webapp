...
function addSortable() {
    ...
    var sortable = '<div class="list-separator"> <i class="fa fa-arrow-down" aria-hidden="true"></i> </div> <ul id="sortable' + lastSortableIndex + '" class="connectedSortable"> <div class="list-label">阶段 ' + lastSortableIndex + '</div> <div class="list-placeholder">(任意事件)</div> <div id="sortables-remove-btn" class="list-delete-btn" onClick="removeSortable()"> <i class="fa fa-minus-circle" aria-hidden="true"></i> </div> </ul>';
...
var chartData = [
    {value:30, name:'Event 3'},
    {value:10, name:'Event 4'},
    {value:5, name:'Event 5'},
    {value:50, name:'Event 2'},
    {value:80, name:'Event 1'}
];
...
$(document).ready(function() {
	...
	option = {
		...
		legend: {
			data : ['Stage 1','Stage 2','Stage 3','Stage 4','Stage 5','Stage 6','Stage 7','Stage 8']
		},
		calculable : true,
		series : [
			//{
